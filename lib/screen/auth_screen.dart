...
// this is used to get the mode of page
                  ...
                  Flexible(
                    child: Container(
                      ...
                      transform: Matrix4.rotationZ(-8 * pi / 180)
                        ..translate(-10.0),
                      // the above is the rotation and the translation using the transform parameter
                      // ..translate(-10.0),
                      // this translate is used for offset
                      decoration: BoxDecoration(
  ...
  Future<void> _submit() async {
    ...
    try {
      if (_authMode == AuthMode.Login) {
        ...
        // thhe sign up returns a future, therefore we change this method to async
        // Sign user up
      }
